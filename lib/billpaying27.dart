                    ...
                    child: Container(width: 387.7,height: 300,decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(17)),color: HexColor('#64D1D0'),),
                      child: Column(children: [
                        Row(
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(top: 10,right: 193,left: 13),
                              child: Text('₹ 2,455/-',style: GoogleFonts.play(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20  ),),
                            ),
                                SizedBox(width: 0,),
                            Padding(
