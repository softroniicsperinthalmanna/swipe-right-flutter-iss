...
import 'dtmpaymentlast56.dart';
class dthpayment extends StatefulWidget {
  const dthpayment({super.key});

  @override
  State<dthpayment> createState() => _dthpaymentState();
}

class _dthpaymentState extends State<dthpayment> {
  var payyy;
  @override
    ...
    return Scaffold(
      body:  Container(
        ...
        child: Column(children: [
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                value: 'pi', groupValue: payyy, onChanged: (value) {
                setState(() {
                  payyy=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Radio(
                activeColor: Colors.white,
                hoverColor: Colors.white,
                value: 'gp', groupValue: payyy, onChanged: (value) {
                setState(() {
                  payyy=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                hoverColor: Colors.white,
                focusColor: Colors.white,
                value: 'vk', groupValue: payyy, onChanged: (value) {
                setState(() {
                  payyy=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                hoverColor: Colors.white,
                focusColor: Colors.white,
                value: 'dd', groupValue: payyy, onChanged: (value) {
                setState(() {
                  payyy=value;
                });
              },),
          ...
          SizedBox(height: 130,),
          InkWell(onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>dthlastpay()));
          },
