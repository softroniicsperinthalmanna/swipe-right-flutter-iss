...
class hltadd extends StatefulWidget {
  const hltadd({super.key});

  @override
  State<hltadd> createState() => _hltaddState();
}

class _hltaddState extends State<hltadd> {
    ...
    return Scaffold(
      body: Container(height: double.infinity,width: double.infinity,color: HexColor('#64D1D0'),
        child: Column(children: [
            ...
            Positioned(
              ...
              child: Container(height: 63,width: 215,decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(13)),color: HexColor('#CACACA')),
                  child: Row(
                    children: [
                      SizedBox(width: 20,),
                      Text('08/09/2023'),SizedBox(width: 60,),
                      Container(height: 35,width: 35,decoration: BoxDecoration(image: DecorationImage(image: AssetImage('asetimage/date.png'))),),
                    ],
                  )
              ),),
          ],),
                      ...
                      Padding(
                        ...
                        child: DropdownButton(
                            ...
                            hint: Padding(
                              ...
                              child: Text('Medicine',style: GoogleFonts.poppins(color: Colors.black,fontSize: 12.5,fontWeight: FontWeight.w500),),
                            ),
                            items: listtt
          ...
          InkWell(onTap: (){},
            child: Container(width: 70,height: 30,decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.all(Radius.circular(7))),
              child: Row(children: [
                Icon(Icons.save),
