...
class wtrbilll extends StatefulWidget {
  const wtrbilll({super.key});

  @override
  State<wtrbilll> createState() => _wtrbilllState();
}

class _wtrbilllState extends State<wtrbilll> {
  @override
      ...
      body: Stack(
          children:[ Container(width: double.infinity,height: double.infinity,color: HexColor('#64D1D0'),
                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          ListTile(
                            leading: Container(height: 38,width: 38,decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(6)),image: DecorationImage(image: AssetImage('asetimage/electricity.png'))),),
                          ...
                          SizedBox(height: 15,),
                          Row(children: [
                            Text('Customer name :',style: GoogleFonts.poppins(color: Colors.white),),SizedBox(width: 13,),
                            Text('Mohammed P',style: GoogleFonts.play(color: Colors.white,fontSize: 13.5),)
                          ],),
                          SizedBox(height: 10,),
                          Row(children: [
                            Text('Amount    :',style: GoogleFonts.poppins(color: Colors.white),),SizedBox(width: 12,),
                            Text('₹ ',style: GoogleFonts.play(color: Colors.white,fontSize: 17.5),),
                            Text('455/-',style: GoogleFonts.play(color: Colors.white,fontSize: 15.5),)
                          ],),
                          SizedBox(height: 12,),
                          Row(children: [
                            Text('Bill Date    :',style: GoogleFonts.poppins(color: Colors.white),),SizedBox(width: 13,),
                            Text( '04/10/2023 ',style: GoogleFonts.play(color: Colors.white,fontSize: 13.5),)
                          ],),SizedBox(height: 1,),
                          Row(children: [
                            Text('Due Date  :',style: GoogleFonts.poppins(color: Colors.white),),SizedBox(width: 12,),
                            Text('30/10/2023',style: GoogleFonts.play(color: Colors.white,fontSize: 13.5),)
                          ],),SizedBox(height: 30,),
                          Padding(
            ...
            Positioned(
                top: 415,left: 130,
                child: InkWell(onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>wtropt()));
                },
