...
import 'package:swiperight/wtrbillpaylast32.dart';
class wtropt extends StatefulWidget {
  const wtropt({super.key});

  @override
  State<wtropt> createState() => _wtroptState();
}

class _wtroptState extends State<wtropt> {
  var paying;
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 130,),
          InkWell(onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>wtrpayy()));
          },
