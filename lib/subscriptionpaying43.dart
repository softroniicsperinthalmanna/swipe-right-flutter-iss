...
import 'package:swiperight/subscpaylast44.dart';
class subpayy extends StatefulWidget {
  const subpayy({super.key});

  @override
  State<subpayy> createState() => _subpayyState();
}

class _subpayyState extends State<subpayy> {
  var paying;
  @override
    ...
    return Scaffold(
      body:  Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 130,),
          InkWell(onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>subscrpaay()));
          },
