...
import 'insurancepaymentlast62.dart';
class insurncpayments extends StatefulWidget {
  const insurncpayments({super.key});

  @override
  State<insurncpayments> createState() => _insurncpaymentsState();
}

class _insurncpaymentsState extends State<insurncpayments> {
  var pay;
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(children: [
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                value: 'pi', groupValue: pay, onChanged: (value) {
                setState(() {
                  pay=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Radio(
                activeColor: Colors.white,
                hoverColor: Colors.white,
                value: 'gp', groupValue: pay, onChanged: (value) {
                setState(() {
                  pay=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                hoverColor: Colors.white,
                focusColor: Colors.white,
                value: 'vk', groupValue: pay, onChanged: (value) {
                setState(() {
                  pay=value;
                });
              },),
          ...
          Container(height: 68,width: 350,decoration: BoxDecoration(color: HexColor('#3CBDBC'),borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Row(children: [
              ...
              Spacer(), Radio(
                ...
                hoverColor: Colors.white,
                focusColor: Colors.white,
                value: 'dd', groupValue: pay, onChanged: (value) {
                setState(() {
                  pay=value;
                });
              },),
          ...
          SizedBox(height: 130,),
          InkWell(onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>insrncelastpayy()));
          },
