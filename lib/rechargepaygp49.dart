...
import 'package:swiperight/rechrgpaylast50.dart';
class rechrgpayy extends StatefulWidget {
  const rechrgpayy({super.key});

  @override
  State<rechrgpayy> createState() => _rechrgpayyState();
}

class _rechrgpayyState extends State<rechrgpayy> {
  var pay;
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 130,),
          InkWell(onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>rechrgpayyyy()));
          },
