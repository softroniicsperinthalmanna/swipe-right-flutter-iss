...
class heallist extends StatefulWidget {
  const heallist({super.key});

  @override
  State<heallist> createState() => _heallistState();
}

class _heallistState extends State<heallist> {
  var sell;
  List liist=[
                   ...
                   child: Row(
                     children: [
                       ...
                       Column(
                         ...
                         children: [
                           Text('PARACETAMOL',style: GoogleFonts.poppins(fontSize: 18.6,fontWeight: FontWeight.w500),),SizedBox(height: 5,),
                           Text('2023/05/22',style: GoogleFonts.roboto(fontSize: 13,fontWeight: FontWeight.w500),),
                         ],),SizedBox(width: 33,),
                       Padding(
                         padding: const EdgeInsets.only(left: 10),
                         child: Column(children: [
                           Text('15',style: GoogleFonts.roboto(color: HexColor('#1D89D8'),fontSize: 23,fontWeight: FontWeight.w500),),SizedBox(height: 5,),
